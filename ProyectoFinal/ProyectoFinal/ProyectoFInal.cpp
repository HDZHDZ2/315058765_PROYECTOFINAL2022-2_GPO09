...
int main()
{
    ...
    Model Cojin((char*)"Models/Cojin/Cojin.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(lightPosLoc, lightPos.x + movelightPosX, lightPos.y + movelightPosY, lightPos.z);
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(0.5f + movelightPosX, 0.5f + movelightPosY, 2.5f));
